...
architecture Behavioral of CalcControlUnit is
   ...
   type TState is (ST_IDLE, ST_MULT_START, ST_CHECKSIGNED, ST_BUFFER_div, ST_BUFFER_mult,ST_MULT_WAIT, ST_DIV_START, ST_DIV_WAIT, ST_SUB_START,ST_ADD_START, ST_SQRT_START, ST_SQRT_WAIT, ST_RESET);
