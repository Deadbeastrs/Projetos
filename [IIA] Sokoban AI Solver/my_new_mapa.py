...
class Map:
    ...
    def __init__(self, filename,teste = True):
        self._map = []
    ...
    def __deepcopy__(self,other):
        other = Map(self._level,False)
        other._map = [row[:] for row in self._map]
        other._keeper = self._keeper
        other.hor_tiles = self.hor_tiles
        other.ver_tiles = self.ver_tiles
        return other
